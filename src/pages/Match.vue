    ...
    timeline: [
      {
        ...
        color: "",
        content: `<p>为了积极响应国家对传染病预防的有力举措，降低传染病的危害，与李兰娟院士的海南省博鳌超级医院合作，拟研发知识驱动的传染病时空演化与预案生成一体化平台，用于辅助中国疾病预防控制中心(CDC)对37种法定传染性疾病的实时网络监测系统，以个人、医院、政府为主要导向生成“三位一体”的防控预案，为降低传染病危害做出一定贡献。</p>`,
        imgs: [
    ...
    timeline: [
      {
        ...
        subtitle: "2022年10月07日-2023年06月30日",
        color: "",
        content: `<p>为解决特殊工况下的电源适配化问题、输出接口兼容性问题以及电源物联赋能需要，拟采取模块化设计思路设计了由PD/AFC/QC诱骗子模块，Buck型DC-DC同步整流子模块，ESP-WROOM-32物联子模块构成的智能物联电源，具备多路独立输出、电源输出控制等功能，为传统电源实用性升级、物联电源的未来设计、与特殊场景的电源适配问题提供解决思路。该项目荣获第十八届“挑战杯”省二等奖，在第十六届计算机设计大赛中获得全国三等奖。</p>`,
        imgs: [
